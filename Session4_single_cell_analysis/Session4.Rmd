...
analysis and pre-prcessing. The first section will demonstrate how to perform
...
data. In Section \@ref(classification) we will train and apply a random
...
[@Weber2016]. For demonstration purposes, we will only highlight the `Phenograph`
clustering approach. For a full overview on different clustering approaches,
please refer to the [Phenotyping](TODO) section of the online book.
